...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
     ...
     */
    public Cuboid expand(@NonNull final CuboidDirection dir, @NonNull final int amount) {
        switch (dir) {
            case North:
     ...
     */
    public Cuboid shift(@NonNull final CuboidDirection dir, @NonNull final int amount) {
     ...
     */
    public Cuboid outset(@NonNull final CuboidDirection dir, @NonNull final int amount) {
        Cuboid c;
        switch (dir) {
            case Horizontal:
     ...
     */
    public Cuboid inset(@NonNull final CuboidDirection dir, @NonNull final int amount) {
     ...
     */
    public boolean contains(@NonNull final int x, @NonNull final int y, @NonNull final int z) {
     ...
     */
    public boolean contains(@NonNull final Block b) {
     ...
     */
    public boolean contains(@NonNull final Location l) {
     ...
     */
    public Cuboid contract(@NonNull final CuboidDirection dir) {
     ...
     */
    public Cuboid getFace(@NonNull final CuboidDirection dir) {
        switch (dir) {
            case Down:
     ...
     */
    public boolean containsOnly(@NonNull final int blockId) {
        for (Block b : this) {
     ...
     */
    public Cuboid getBoundingCuboid(@NonNull final Cuboid other) {
        if (other == null)
            return this;
     ...
     */
    public Block getRelativeBlock(@NonNull final int x, @NonNull final int y, @NonNull final int z) {
     ...
     * @return The block at the given position
     */
    public Block getRelativeBlock(@NonNull final World w, @NonNull final int x, @NonNull final int y, @NonNull final int z) {
